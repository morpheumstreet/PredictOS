# Polyback MM: market making integration

This document maps **`mm/polyback-mm`** market-making behavior to packages, YAML, and PredictOS **terminal** integration. It assumes the existing Clean Architecture layout (`ports`, `wiring`, `domain`, `internal/platforms/polymarket/ws`). For **why** MM needs defenses (toxic flow, stale quotes), see [market-making-risks.md](market-making-risks.md).

Upstream tree reference: `https://github.com/morpheumstreet/PredictOS/tree/main/mm/polyback-mm`.
...
│   │       └── clickhouse_port.go
│   │
│   ├── strategy/                        # quoting, toxicity, depth, risk, TWAP, etc.
│   │   ├── quoting/
...
### 4. Quoting formula (reservation + skew + toxicity)
...
| Requirement (see [market-making-risks](market-making-risks.md)) | Where it lives                              | Status |
|---------------------------------------|---------------------------------------------|--------|
...
- [market-making-risks.md](market-making-risks.md) — adversarial context and defense checklist
- [../../architecture/sqlite-vs-clickhouse.md](../../architecture/sqlite-vs-clickhouse.md) — analytics storage boundaries
- [../../guides/betting-bots.md](../../guides/betting-bots.md) — user-facing 15m bot setup